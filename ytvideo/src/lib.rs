//! YouTube Video — bex-core content-resolver plugin.
//!
//! Ported from the standalone `ytvideo` crate to use bex-core.
//! Provides access to YouTube Video content: home sections, search, video/playlist
